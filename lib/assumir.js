...
// ⚠️ A INVALIDADA NÃO É LIVRE — fase 2, 02/09/2026. 24 das 59 abertas candidatas têm
// `status = 'livre'`; sem esta cláusula o analista assumiria uma PC que o resto do sistema
// já não conta, e o `resumo_tr` ofereceria no Estoque uma TR que não tem trabalho dentro.
const PC_LIVRE_SQL = `analista_id IS NULL AND status = 'livre' AND ${inval.ativa('')}`;
