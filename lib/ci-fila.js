...
//
// ⚠️ E ESTA LIB NUNCA TOCA NA BAIXA. Nem a abertura, nem a devolução à fila, nem o passar a
// outro mexem em `baixada`, `data_baixa`, `enviado_ci` ou `ci_situacao`: quem está com a PC é
// uma pergunta, e onde ela está no ciclo é outra. Há teste que falha se um UPDATE daqui
// mencionar qualquer uma das quatro.
//
