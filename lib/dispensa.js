 ...
 *
 * ⚠️ É o predicado que a soma de meta usa. Medido em 28/08: das 46 metas vigentes, **45 têm
 * `analista_id`** e somam **5.041** — são essas que chegam à tela. Tirando as 7 dos
 * dispensados (643), ficam **38 metas somando 4.398**.
 *
 * ⚠️ A 46ª NUNCA CONTOU, e por isso ela não entra nesta conta. É a meta id 30, da Caroline
 * (27), com `analista_id` NULO: a tela indexa por id (`if (m.analista_id)`), então ela nunca
 * esteve em soma nenhuma. Dizer "46 viram 39, 5.068 viram 4.425" — como esta frente disse
 * antes de medir — conta uma linha órfã dos DOIS lados da subtração, e o erro se cancela na
 * diferença mas mente nos dois totais.
 *
