...
//
// ⚠️ EDITAR `processo_pc` NÃO MUDA O AGRUPAMENTO DA PARCIAL — e até 16/08/2026 este
// comentário dizia o contrário.
//
// A regra escrita aqui era "uma parcial = (tr, processo_pc)", e dela nascia o `fusao` da
// rota: se o processo corrigido já existisse na TR, o servidor igualava o `parcial_num` das
// duas. **A regra é falsa.** No estoque oficial da CGE, um processo SGPe carrega várias
// parcelas do SIGEF em 113 pares (tr, processo) — 78 TRs, 465 PCs, e uma TR com 11 parcelas
// no mesmo processo. Ela parecia verdadeira porque o dado do banco estava deformado pela
// recarga de 05/08 e pela renumeração de 13/08.
//
// Quem agrupa a parcela é o `parcial_num`, e só ele: é assim no `carregarParcela`
// (`server.js`), nos cinco chamadores dele e no agrupamento da tela. O `fusao` e o `juntar`
// saíram da rota; o que restou é o `convive`, que informa e não escreve.
