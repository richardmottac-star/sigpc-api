 ...
 * a pessoa não ocupa.
 *
 * ⚠️ ORIGEM NÃO DÁ CIÊNCIA. Ela abre o termo (`podeVerRepasse`), porque o acervo foi dela, mas
 * não há o que ela declare assumir: o repasse tira PCs dela, não lhe entrega nenhuma.
 */
function condicaoCiencia(quem, lote) {
  ...
  if (quem.perfil === 'coordenador' && !quem.data_saida) {
...
module.exports = {
  ...
  SQL_CIENCIA_GRAVAR, SQL_CIENCIAS, SQL_CIENCIAS_CONTA,
